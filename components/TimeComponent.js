...
export default function TimeComponent() {
  return (
    <div id="schedule" className="relative overflow-hidden bg-gray-900">
      <div className="relative px-4 py-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <h2 className="text-4xl font-extrabold text-center tracking-tight text-white sm:text-4xl md:text-4xl">
          Waktu Pernikahan
        </h2>
        <div className="max-w-3xl mx-auto mt-16 relative">
          ...
          <div className="mt-6 text-gray-300">
            <div className="flex items-center justify-center mb-8">
              ...
              <div className="ml-4">
                <span className="text-lg text-white">14 Agustus 2023</span>
              </div>
            </div>
            <div className="flex items-center justify-center mb-8">
              ...
              <div className="ml-4">
                <span className="text-lg text-gray-400">Akad Nikah: 09.00 WIB</span>
              </div>
            </div>
            <div className="flex items-center justify-center">
              ...
              <div className="ml-4">
                <span className="text-lg text-gray-400">Resepsi: 11.00 - 15.00 WIB</span>
              </div>
            </div>
          </div>
        </div>
